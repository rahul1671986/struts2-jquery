...
This tag generates an Text Input Field that loads its content using an ajax call, via the jQuery framework.

# Samples #

## Load content into Text Input Field ##
```
...
## Load content into Text Input Field with effect ##
...
<html>
  ...
  <body>
	<s:form>
		<s:url var="urlsimpleecho" action="simpleecho"><s:param name="echo">remote content for textfield!</s:param></s:url>
		<sj:textfield href="%{urlsimpleecho}" effect="pulsate" effectDuration="1500" id="echo" name="echo" loadingText="Loading content of textfield ..."/>
	</s:form>	
  </body>
</html>
```
...
## Load content into resizable Text Input Field ##
```
<%@ taglib prefix="s" uri="/struts-tags"%>
<%@ taglib prefix="sj" uri="/struts-jquery-tags"%>
<html>
  ...
  <body>
	<s:form>
		<s:url var="urlsimpleecho" action="simpleecho"><s:param name="echo">remote content for textfield!</s:param></s:url>
		<sj:textfield href="%{urlsimpleecho}" resizable="true" resizableGhost="true" resizableHelper="ui-state-highlight" resizableMaxHeight="30" id="echo" name="echo" loadingText="Loading content of textfield ..."/>
	</s:form>	
  </body>
</html>
```
